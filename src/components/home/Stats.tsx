        ...
        <div className="grid gap-8 lg:grid-cols-[1.1fr_1fr] lg:items-end lg:gap-16">
          <Reveal>
            <h2 className="display-xl max-w-3xl text-white">
              Three decades of supply that industry can count on.
            </h2>
          </Reveal>
          <Reveal delay={0.12}>
            <p className="body-lg max-w-md text-white/60">
              Since 1995 we have built a reputation on consistent quality,
              honest pricing, and dispatch you can plan production around. The
