        ...
        <div className="grid gap-10 lg:grid-cols-[1fr_1fr] lg:items-end">
          <Reveal>
            ...
            <h2 className="display-lg mt-6 max-w-lg text-white">
              Chemicals engineered for the industries that build and care.
            </h2>
          </Reveal>
          <Reveal delay={0.1}>
            <p className="body-lg max-w-md text-white/55">
              Tap any segment to see the product families and grades we supply
              for it. Our technical team can recommend specific items for your
              formulation.
            </p>
          </Reveal>
        </div>
