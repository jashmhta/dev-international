...
const steps = [
  {
    n: "01",
    title: "Quality products from trusted sources, every shipment",
  },
  {
    n: "02",
  ...
  {
    n: "03",
    title: "Timely service with a well-equipped godown at Bhiwandi",
  },
  {
    n: "04",
      ...
      <div className="site-container">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <Reveal delay={0.08}>
            <h2 className="display-lg mt-6 text-alethia-dark">
              The Biggest Advantage in Chemicals: Reliability
            </h2>
          </Reveal>
          <Reveal delay={0.12}>
        ...
        <Reveal delay={0.1} className="mx-auto mt-16 max-w-3xl text-center">
          <h3 className="display-md text-alethia-dark">
            We&apos;re Not Just Supplying Chemicals.
            <br />
